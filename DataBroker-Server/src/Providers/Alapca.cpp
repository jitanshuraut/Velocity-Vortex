...
std::vector<Bar> Alapca::GetHistoricalBars(const std::string &symbols, const std::string &timeframe, const std::string &start, const std::string &end)
{
...
Bar Alapca::GetLatestBars(const std::string &symbols)
{
    std::ostringstream url;
...
std::vector<Quote> Alapca::GetHistoricalQuotes(const std::string &symbols, const std::string &start, const std::string &end)
{
    std::ostringstream url;
...
Quote Alapca::GetLatestQuotes(const std::string &symbols)
{
    std::ostringstream url;
...
std::vector<Trade> Alapca::GetHistoricalTrades(const std::string &symbols, const std::string &start, const std::string &end)
{
    std::ostringstream url;
...
Trade Alapca::GetLatestTrades(const std::string &symbols)
{
    std::ostringstream url;
