...
{
public:
    TwelveData(std::string apikey_, std::string secretKey_, int port_,std::string provider_name_) : apiKey(apikey_), secretKey(secretKey_), port(port_), provider_name(provider_name_) {};
    void initialize();
